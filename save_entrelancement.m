...
inter = comm.MatrixInterleaver('NumRows',378,'NumColumns',100);
deinter = comm.MatrixDeinterleaver('NumRows',378,'NumColumns',100);
...
%             msg = msg.';
        ...
        for i =1:378 %bit paquets par trames +48 :/
