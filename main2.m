...
for i_snr = 1:length(EbN0dB)
    ...
    while (err_stat(2) < nbr_erreur && err_stat(3) < nbr_bit_max)
        ...
        msg_crs =  step(RS,msg);
        msg_crs = step(inter,msg_crs);
        
        
        msg_c = H.step(msg_crs);          % Encodage du message
        ...
        rec_msg_entre = step(deinter,rec_msg(1:378*pqt_par_trame));       % Déentrelacement
